 ...
 *
 * Be sure to replace all instances of 'foodlymentor_' with your project's prefix.
...
function foodly_additional_options_metabox()
{
	...
	$cmb2_box->add_group_field($group_field_id, array(
		'name'             => esc_html__('Option Type', 'cmb2'),
		'desc'             => esc_html__('Select type of this option', 'cmb2'),
		'id'               => 'option_type',
		'type'             => 'select',
		'options'          => array(
	...
	$cmb2_box->add_group_field($group_field_id, array(
		'name'             => esc_html__('Required?', 'cmb2'),
		'desc'             => esc_html__('Select this option is required or not', 'cmb2'),
		'id'               => 'option_required',
		'type'             => 'select',
		'options'          => array(
	...
	$cmb2_box->add_group_field($group_field_id, array(
		'name'       => esc_html__('Minimun Selection', 'cmb2'),
		'desc'             => esc_html__('Enter number minimum at least option required', 'cmb2'),
		'id'         => 'min_selection',
		'type'       => 'text',
	));

	$cmb2_box->add_group_field($group_field_id, array(
		'name'       => esc_html__('Maximum Selection', 'cmb2'),
	...
	$cmb_demo = new_cmb2_box(array(
		'id'            => 'demo_additional_options',
		'title'         => esc_html__('Demo Additional Options', 'cmb2'),
		'object_types'  => array('page'), // Post type
		// 'show_on_cb' => 'foodlymentor_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'foodlymentor_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field(array(
		...
		'id'         => 'foodlymentor_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'foodlymentor_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textsmall',
		'type' => 'text_small',
		// 'repeatable' => true,
		// 'column' => array(
		...
		// );
		// 'display_cb' => 'foodlymentor_display_text_small_column', // Output the display of the column values through a callback.
	));

	$cmb_demo->add_field(array(
		'name' => esc_html__('Test Text Medium', 'cmb2'),
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textmedium',
		'type' => 'text_medium',
	));
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'foodlymentor_render_row_cb',
	));

	$cmb_demo->add_field(array(
		'name' => esc_html__('Website URL', 'cmb2'),
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_url',
		'type' => 'text_url',
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'foodlymentor_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	));

	$cmb_demo->add_field(array(
		'name' => esc_html__('Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2'),
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'foodlymentor_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textmoney',
		'type' => 'text_money',
	...
	$cmb_demo->add_field(array(
		...
		'desc'    => esc_html__('field description (optional)', 'cmb2'),
		'id'      => 'foodlymentor_demo_colorpicker',
		'type'    => 'colorpicker',
		'default' => '#ffffff',
		// 'options' => array(
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textareasmall',
		'type' => 'textarea_small',
	));
	...
	$cmb_demo->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_demo_textarea_code',
		'type' => 'textarea_code',
		// 'attributes' => array(
	...
	$cmb_demo->add_field(array(
		...
		'desc'             => esc_html__('field description (optional)', 'cmb2'),
		'id'               => 'foodlymentor_demo_radio_inline',
		'type'             => 'radio_inline',
	...
	$cmb_demo->add_field(array(
		...
		'desc'     => esc_html__('field description (optional)', 'cmb2'),
		'id'       => 'foodlymentor_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field(array(
		...
		'desc'     => esc_html__('field description (optional)', 'cmb2'),
		'id'       => 'foodlymentor_demo_taxonomy_select',
	...
	$cmb_demo->add_field(array(
		...
		'desc'     => esc_html__('field description (optional)', 'cmb2'),
		'id'       => 'foodlymentor_demo_multitaxonomy',
	...
	$cmb_demo->add_field(array(
		...
		'desc'    => esc_html__('field description (optional)', 'cmb2'),
		'id'      => 'foodlymentor_demo_multicheckbox',
		'type'    => 'multicheck',
	...
	$cmb_demo->add_field(array(
		...
		'id'           => 'foodlymentor_demo_file_list',
		'type'         => 'file_list',
	...
	$cmb_demo->add_field(array(
		...
		'id'   => 'foodlymentor_demo_embed',
		'type' => 'oembed',
	));

	$cmb_demo->add_field(array(
		'name'         => 'Testing Field Parameters',
		'id'           => 'foodlymentor_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'foodlymentor_before_row_if_2', // callback.
...
add_action('cmb2_admin_init', 'foodlymentor_register_repeatable_group_field_metabox');
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function foodlymentor_register_repeatable_group_field_metabox()
{
	...
	$cmb_group = new_cmb2_box(array(
		'id'           => 'foodlymentor_group_metabox',
		'title'        => esc_html__('Repeating Field Group', 'cmb2'),
		'object_types' => array('page'),
	));

	// $group_field_id is the field id string, so in this case: 'foodlymentor_group_demo'
	$group_field_id = $cmb_group->add_field(array(
		'id'          => 'foodlymentor_group_demo',
		'type'        => 'group',
...
add_action('cmb2_admin_init', 'foodlymentor_register_user_profile_metabox');
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function foodlymentor_register_user_profile_metabox()
{
	...
	$cmb_user->add_field(array(
		...
		'desc'     => esc_html__('field description (optional)', 'cmb2'),
		'id'       => 'foodlymentor_user_extra_info',
		'type'     => 'title',
		'on_front' => false,
	));
	...
	$cmb_user->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_user_facebookurl',
		'type' => 'text_url',
	));
	...
	$cmb_user->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_user_twitterurl',
		'type' => 'text_url',
	));
	...
	$cmb_user->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_user_googleplusurl',
		'type' => 'text_url',
	));
	...
	$cmb_user->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_user_linkedinurl',
		'type' => 'text_url',
	));
	...
	$cmb_user->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_user_user_text_field',
		'type' => 'text',
	));
}

add_action('cmb2_admin_init', 'foodlymentor_register_taxonomy_metabox');
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function foodlymentor_register_taxonomy_metabox()
{
	...
	$cmb_term->add_field(array(
		'name'     => esc_html__('Extra Info', 'cmb2'),
		'desc'     => esc_html__('field description (optional)', 'cmb2'),
		'id'       => 'foodlymentor_term_extra_info',
		'type'     => 'title',
		'on_front' => false,
	));
	...
	$cmb_term->add_field(array(
		...
		'desc' => esc_html__('field description (optional)', 'cmb2'),
		'id'   => 'foodlymentor_term_term_text_field',
		'type' => 'text',
	));
}

add_action('cmb2_admin_init', 'foodlymentor_register_theme_options_metabox');
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function foodlymentor_register_theme_options_metabox()
{
	...
	$cmb_options = new_cmb2_box(array(
		'id'           => 'foodlymentor_theme_options_page',
		...
		'option_key'      => 'foodlymentor_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'foodlymentor_options_page_message_callback',
 ...
 * }
 */
function foodlymentor_options_page_message_callback($cmb, $args)
{
 ...
 */
function foodlymentor_limit_rest_view_to_logged_in_users($is_allowed, $cmb_controller)
{
...
add_action('cmb2_init', 'foodlymentor_register_rest_api_box');
/**
 ...
 */
function foodlymentor_register_rest_api_box()
{
	$cmb_rest = new_cmb2_box(array(
		'id'            => 'foodlymentor_rest_metabox',
		...
		// 'get_box_permissions_check_cb' => 'foodlymentor_limit_rest_view_to_logged_in_users',
	));
	...
	$cmb_rest->add_field(array(
		...
		'id'         => 'foodlymentor_rest_editable_text',
		'type'       => 'text',
